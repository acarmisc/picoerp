...
<div id="content">
	...
	<p align="center" class="heading_1">PURCHASE ORDER - ORDINE D'ACQUISTO</p>
	
	<div id="incipit">
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<td width="50%" align="center" class="heading_1"><p><i>SUPPLIER - FORNITORE</i></p></td>
			...
			<tr>
				...
				<?= nl2br($object['head']->delivery_address) ?>
				</td>
			</tr>
		</table>
		...
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<td width="60%">
					...
					<p class="value"><?= $object['head']->ref ?></p>
					<p class="heading_1"><i>P.O. Date - Data Ordine:</i></p>
					<p class="value"><?= $object['head']->order_date ?></p>
					<p class="heading_1"><i>Delivery time - Tempo di Consegna:</i></p>
					<p class="value"><?= $object['head']->delivery_time ?></p>
					<p class="heading_1"><i>Warranty Terms:</i></p>
					<p class="value"><?= $object['head']->warranty_terms ?></p>
				</td>
				<td width="40%">
	...
	<div id="rows">
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr>
				<th>Quant.<br />Quant.</th>
				<th>M.U.<br />U.M.</th>
				<th>Description<br />Descrizione</th>
				<th>Price<br />Prezzo</th>
				<th>%Disc.<br />%Sc.</th>
				<th>Total<br />Totale</th>
			</tr>
	...
	<div id="foot_note">
		<table cellspacing="0" cellpadding="0" width="90%">
			...
			<tr>
				<td width="30%" class="heading_1">Our project Number</td>
				<td class="value">: <?= $object['head']->project_name ?></td>
			</tr>
			<tr>
			...
			<p align="right" class="value" style="margin-right: 0.5cm">Net Total Price (ex. VAT) - Prezzo totale (IVA esc.): <b><?= money_format('%.2n',$object['head']->price_final) ?></b></p>
	...
	<br />
	<br />
			Approved by - Approvato da<br />
			<?= whoami($object['head']->approved_by) ?>
			</div>	
	</div>
