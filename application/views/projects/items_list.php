...
<?php foreach($items as $i): ?>
	...
	<div class="agile_list_item">
		<div class="agile_list_actions pull-right">
			<span href="#" class="add-el-to-purchase" name="<?= $i->id ?>"><i class="icon-share" rel="tooltip" title="Add to purchase order"></i></span>
		</div>
		<div class="agile_list_title"><?= $i->code ?> <?= $i->item ?><br />
			<?= $i->brand ?></div>
